...
$("#n-checkerboard").bind('click'), toggleDisplay("checkerboard")
$("#n-cross").bind('click'), toggleDisplay("cross")
$("#n-lower-triangle").bind('click'), toggleDisplay("lower-triangle")
$("#n-upper-triangle").bind('click'), toggleDisplay("upper-triangle")
$("#n-upside-down-trapezoid").bind('click'), toggleDisplay("upside-down-trapezoid")
